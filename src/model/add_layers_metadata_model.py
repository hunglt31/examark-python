...
model = onnx.load("./assets/models/metadata/weights/best.onnx")
graph = model.graph
input0 = helper.make_tensor_value_info("input0", TensorProto.UINT8, [2, 640, 640, 3])
...
bbox_ends = np.array([2, 8400, 4], dtype=np.int64)
...
score_ends = np.array([2, 8400, 6], dtype=np.int64)
...
onnx.save(model, "./assets/models/metadata.onnx")
